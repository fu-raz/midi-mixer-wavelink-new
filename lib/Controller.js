...
module.exports = class Controller
{
    ...
    outputLevelsChanged()
    {
        // { identifier: input.identifier, updateAll: true }
    }
    ...
    inputLevelsChanged(inputData)
    {
        ...
        {
            mixerAssignmentMonitor.meter = input.levelLeft / 100 * mixerAssignmentMonitor.volume;
        }

        let mixerAssignmentStream = this.getMixerAssignment(`${input.identifier}_stream`);
        if (mixerAssignmentStream)
        {
            mixerAssignmentStream.meter = input.levelLeft / 100 * mixerAssignmentStream.volume;
        }
    }
